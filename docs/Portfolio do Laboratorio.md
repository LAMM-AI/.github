...
Fonte: PDFs locais (não versionados) em `projetos/planos/` (planos) e `projetos/producoes/` (produções). Atualizado em 13/01/2026.
...
graph TD
  LEMM((LEMM.IA))
  P23716["23716 • Fractal/PCA • Mercado financeiro"]
  P24039["24039 • IoT+Blockchain • Estruturas civis"]
  P24354["24354 • Risco de acidentes • Aviação"]
  P24382["24382 • DRL • Criptomoedas"]
  P24434["24434 • Otimização • Fundações"]
  P24508["24508 • Meta-heurísticas • Bin Packing"]
  P24589["24589 • Imputação • Dados climáticos"]
  P24616["24616 • Fog/IoT • Gêmeo digital + Drone"]
  ART_ANDRESSA["Mini artigo • PIAT (RUL em motores)"]
...
- PDF (local): `Mini_Artigo_Andressa.pdf`
